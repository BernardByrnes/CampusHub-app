...
CREATE TABLE "xp_ledger_entries" (
	...
	CONSTRAINT "xp_ledger_entries_reciprocal_unique" UNIQUE("tenant_id","source_claim_id","membership_id","id","entry_type","rule_id","source_kind","source_reference_id","source_occurrence"),
...
CREATE TABLE "xp_source_claims" (
	...
	CONSTRAINT "xp_source_claims_reciprocal_unique" UNIQUE("tenant_id","id","membership_id","canonical_ledger_entry_id","expected_entry_type","rule_id","source_kind","source_reference_id","source_occurrence"),
...
ALTER TABLE "xp_source_claims"
  ...
  FOREIGN KEY ("tenant_id", "id", "membership_id", "canonical_ledger_entry_id", "expected_entry_type", "rule_id", "source_kind", "source_reference_id", "source_occurrence")
  REFERENCES "public"."xp_ledger_entries" ("tenant_id", "source_claim_id", "membership_id", "id", "entry_type", "rule_id", "source_kind", "source_reference_id", "source_occurrence")
...
ALTER TABLE "xp_ledger_entries"
  ...
  FOREIGN KEY ("tenant_id", "source_claim_id", "membership_id", "id", "entry_type", "rule_id", "source_kind", "source_reference_id", "source_occurrence")
  REFERENCES "public"."xp_source_claims" ("tenant_id", "id", "membership_id", "canonical_ledger_entry_id", "expected_entry_type", "rule_id", "source_kind", "source_reference_id", "source_occurrence")
  DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
...
GRANT SELECT, INSERT, REFERENCES ON TABLE "xp_ledger_entries", "xp_source_claims", "xp_event_rsvp_source_claims" TO "campushub_runtime";--> statement-breakpoint
REVOKE UPDATE, DELETE, TRUNCATE, TRIGGER ON TABLE "xp_ledger_entries", "xp_source_claims", "xp_event_rsvp_source_claims" FROM "campushub_runtime";--> statement-breakpoint
GRANT REFERENCES ON TABLE "tenants", "memberships", "events" TO "campushub_runtime";

    ...
    select (
      ...
      and not exists (
        ...
        where authority_role.rolsuper
           ...
           or has_any_column_privilege(authority_role.rolname, 'public.tenants', 'REFERENCES')
           or has_table_privilege(authority_role.rolname, 'public.memberships', 'REFERENCES')
           or has_any_column_privilege(authority_role.rolname, 'public.memberships', 'REFERENCES')
           or has_table_privilege(authority_role.rolname, 'public.events', 'REFERENCES')
           or has_any_column_privilege(authority_role.rolname, 'public.events', 'REFERENCES')
           or has_table_privilege(authority_role.rolname, 'public.xp_ledger_entries', 'REFERENCES')
           or has_any_column_privilege(authority_role.rolname, 'public.xp_ledger_entries', 'REFERENCES')
           or has_table_privilege(authority_role.rolname, 'public.xp_source_claims', 'REFERENCES')
           or has_any_column_privilege(authority_role.rolname, 'public.xp_source_claims', 'REFERENCES')
           or has_table_privilege(authority_role.rolname, 'public.xp_event_rsvp_source_claims', 'REFERENCES')
           or has_any_column_privilege(authority_role.rolname, 'public.xp_event_rsvp_source_claims', 'REFERENCES')
      )
      ...
      and not has_any_column_privilege(current_user, 'public.tenants', 'REFERENCES')
      ...
      and not has_any_column_privilege(current_user, 'public.memberships', 'REFERENCES')
      ...
      and not has_any_column_privilege(current_user, 'public.events', 'REFERENCES')
      ...
      and not has_any_column_privilege(current_user, 'public.xp_ledger_entries', 'REFERENCES')
      ...
      and not has_any_column_privilege(current_user, 'public.xp_source_claims', 'REFERENCES')
      ...
      and not has_any_column_privilege(current_user, 'public.xp_event_rsvp_source_claims', 'REFERENCES')
    ) as allowed

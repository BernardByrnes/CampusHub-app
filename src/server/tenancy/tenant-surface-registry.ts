...
export const APPROVED_GLOBAL_NON_TENANT_CONTRACTS = {
  ...
  "organiser.services.factory": {
    category: "infrastructure",
    implementationPath: "src/server/organisers/create-organiser-services.ts",
    operation: "createOrganiserServices",
  },
} as const satisfies Readonly<
  Record<
...
export const REVIEWED_NON_OPERATIONAL_CONSTRUCTOR_CONTRACTS = [
  ...
  },
  {
    ...
    classIdentity: "EventManagementService",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["dependencies"],
    parameterTypeTexts: ["EventManagementServiceDependencies"],
    parameterPropertyModifiers: [["private", "readonly"]],
    defaultInitializerIdentifiers: [null],
  },
  {
    implementationPath: "src/application/events/read-events.ts",
    classIdentity: "ReadEventService",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["dependencies"],
    parameterTypeTexts: ["EventReadServiceDependencies"],
    parameterPropertyModifiers: [["private", "readonly"]],
    defaultInitializerIdentifiers: [null],
  },
  {
    implementationPath: "src/server/repositories/event-repository.ts",
    classIdentity: "DrizzleEventRepository",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["database"],
    parameterTypeTexts: ["CampusHubDatabase"],
  ...
  },
  {
    ...
    classIdentity: "PostgresAuthorizedEventManagementExecutor",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["dependencies"],
    parameterTypeTexts: ["PostgresAuthorizedEventManagementDependencies"],
    parameterPropertyModifiers: [["private", "readonly"]],
    defaultInitializerIdentifiers: [null],
  },
  {
    implementationPath: "src/application/organisers/manage-organisers.ts",
    classIdentity: "OrganiserManagementService",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["dependencies"],
    parameterTypeTexts: ["OrganiserManagementServiceDependencies"],
    parameterPropertyModifiers: [["private", "readonly"]],
    defaultInitializerIdentifiers: [null],
  },
  {
    implementationPath: "src/server/repositories/organiser-repository.ts",
    classIdentity: "DrizzleOrganiserRepository",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["database"],
    parameterTypeTexts: ["CampusHubDatabase"],
  ...
  {
    implementationPath: "src/server/authorization/postgres-authorized-organisers.ts",
    classIdentity: "PostgresAuthorizedOrganiserManagementExecutor",
    constructorModifiers: ["public"],
    parameterCount: 1,
    parameterNames: ["dependencies"],
    parameterTypeTexts: ["PostgresAuthorizedOrganiserManagementDependencies"],
    parameterPropertyModifiers: [["private", "readonly"]],
    defaultInitializerIdentifiers: [null],
  },
  {
    implementationPath: "src/server/authorization/postgres-privileged-mutation-authority.ts",
    classIdentity: "PostgresPrivilegedMutationAuthority",
    constructorModifiers: ["public"],
    parameterCount: 0,
    parameterNames: [],
    parameterTypeTexts: [],
    parameterPropertyModifiers: [],
    defaultInitializerIdentifiers: [],
  },
...
export const tenantSurfaceRegistry = [
  ...
  },
  {
    ...
    surface: "organisers",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Organiser rows are Tenant-owned, composite Tenant-identified, bounded, and versioned.",
    requiredNegativeTestIds: ["organisers.persistence"],
    databaseObjectName: "organisers",
    operation: "table:organisers",
  },
  {
    id: "organisers.repository",
    category: "repository",
    implementationPath: "src/server/repositories/organiser-repository.ts",
    surface: "DrizzleOrganiserRepository",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Every Organiser lookup and mutation requires explicit Tenant plus Organiser identity; no delete/archive operation exists.",
    requiredNegativeTestIds: ["organisers.direct", "organisers.collection"],
  },
  ...(["prepareCreateOrganiserInTransaction", "createOrganiserInTransaction", "prepareOrganiserMutationInTransaction", "updateOrganiserInTransaction", "findOrganiserByIdForTenant", "listOrganisersForTenant"] as const).map((operation) => ({
    id: `organisers.repository-${operation}`,
    category: "repository" as const,
    implementationPath: "src/server/repositories/organiser-repository.ts",
    surface: `DrizzleOrganiserRepository.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
    isolationStrategy: "Organiser repository operation is Tenant-bound and does not resolve a row by identifier alone.",
    requiredNegativeTestIds: ["organisers.direct", "organisers.collection"],
    operation: `DrizzleOrganiserRepository.${operation}`,
  })),
  {
    id: "organisers.audit-append",
    category: "repository",
    implementationPath: "src/server/repositories/audit-event-repository.ts",
    surface: "DrizzleAuditEventRepository.appendOrganiserMutationInTransaction",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Organiser lifecycle audit events append to the same immutable Tenant transaction as the Organiser mutation.",
    requiredNegativeTestIds: ["audit.persistence"],
    operation: "DrizzleAuditEventRepository.appendOrganiserMutationInTransaction",
  },
  {
    id: "organisers.authorized-management",
    category: "application_service",
    implementationPath: "src/server/authorization/postgres-authorized-organisers.ts",
    surface: "PostgresAuthorizedOrganiserManagementExecutor",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Organiser mutations use organiser.manage, the reusable PMAFB lock/recheck boundary, database-time freshness, and an atomic audit append.",
    requiredNegativeTestIds: ["organisers.authorization"],
  },
  ...(["createOrganiser", "updateOrganiser"] as const).map((operation) => ({
    id: `organisers.authorized-${operation}`,
    category: "application_service" as const,
    implementationPath: "src/server/authorization/postgres-authorized-organisers.ts",
    surface: `PostgresAuthorizedOrganiserManagementExecutor.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
    isolationStrategy: "Organiser mutation is capability-gated and remains inside one Tenant-bound PostgreSQL transaction.",
    requiredNegativeTestIds: ["organisers.authorization"],
    operation: `PostgresAuthorizedOrganiserManagementExecutor.${operation}`,
  })),
  {
    id: "organisers.management",
    category: "application_service",
    implementationPath: "src/application/organisers/manage-organisers.ts",
    surface: "OrganiserManagementService",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Organiser management commands require trusted RequestContext, exact Tenant scope, bounded fields, and organiser.manage.",
    requiredNegativeTestIds: ["organisers.management"],
  },
  ...(["createOrganiser", "editOrganiser", "listOrganisers"] as const).map((operation) => ({
    id: `organisers.management-${operation}`,
    category: "application_service" as const,
    implementationPath: "src/application/organisers/manage-organisers.ts",
    surface: `OrganiserManagementService.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
    isolationStrategy: "Organiser management operation rejects mismatched Tenant scope before persistence and uses trusted actor facts.",
    requiredNegativeTestIds: ["organisers.management"],
    operation: `OrganiserManagementService.${operation}`,
  })),
  {
    id: "organiser.services.factory",
    category: "infrastructure",
    implementationPath: "src/server/organisers/create-organiser-services.ts",
    surface: "createOrganiserServices",
    tenantScope: "GLOBAL_NON_TENANT",
    isolationStrategy: "The factory only wires server-side Organiser dependencies; all returned resource operations remain Tenant-bound.",
    requiredNegativeTestIds: [],
    globalExemptionReason: "This is a dependency-injection factory with no direct resource query or authority decision; constructed services enforce Tenant scope.",
    operation: "createOrganiserServices",
  },
  {
    id: "events.persistence",
    category: "model",
    implementationPath: "src/server/db/schema/events.ts",
    surface: "events",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Event rows are Tenant-owned, composite Tenant-identified, versioned, and lifecycle constrained.",
    requiredNegativeTestIds: ["events.persistence"],
    databaseObjectName: "events",
    operation: "table:events",
  },
  {
    id: "event-audience.persistence",
    category: "model",
    implementationPath: "src/server/db/schema/events.ts",
    surface: "event_audience_criteria",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Event audience criteria bind Event and every referenced target through same-Tenant composite foreign keys.",
    requiredNegativeTestIds: ["event-audience.persistence"],
    databaseObjectName: "event_audience_criteria",
  ...
  },
  {
    ...
    category: "repository",
    implementationPath: "src/server/repositories/event-repository.ts",
    surface: "DrizzleEventRepository",
    tenantScope: "TENANT_SCOPED",
  ...
  ...(["createEventInTransaction", "prepareCreateEventInTransaction", "findEventByIdForTenant", "listLifecycleHistoryForTenant", "listEventsForTenant", "prepareEventMutationInTransaction", "updateEventInTransaction", "appendLifecycleHistoryInTransaction", "publishEventInTransaction", "postponeEventInTransaction", "republishEventInTransaction", "cancelEventInTransaction"] as const).map((operation) => ({
    ...
    category: "repository" as const,
    implementationPath: "src/server/repositories/event-repository.ts",
    surface: `DrizzleEventRepository.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
  ...
  })),
  {
    ...
    category: "repository",
    implementationPath: "src/server/repositories/audit-event-repository.ts",
    surface: "DrizzleAuditEventRepository.appendEventMutationInTransaction",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Event lifecycle audit events append to the same immutable Tenant transaction as the Event mutation.",
    requiredNegativeTestIds: ["audit.persistence"],
    operation: "DrizzleAuditEventRepository.appendEventMutationInTransaction",
  },
  {
    id: "events.authorized-management",
    category: "application_service",
    implementationPath: "src/server/authorization/postgres-authorized-events.ts",
    surface: "PostgresAuthorizedEventManagementExecutor",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Event mutations use event.manage, the reusable PMAFB lock/recheck boundary, database-time freshness, and an atomic audit append.",
  ...
  },
  {
    ...
    category: "application_service",
    implementationPath: "src/server/authorization/postgres-privileged-mutation-authority.ts",
    surface: "PostgresPrivilegedMutationAuthority.run",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "The reusable PMAFB locks authority rows, waits for the resource callback, re-reads authority and PostgreSQL clock_timestamp(), then immediately guards the mutation.",
    requiredNegativeTestIds: ["events.authorization"],
  ...
  ...(["createEvent", "updateEvent", "publishEvent", "postponeEvent", "republishEvent", "cancelEvent"] as const).map((operation) => ({
    ...
    category: "application_service" as const,
    implementationPath: "src/server/authorization/postgres-authorized-events.ts",
    surface: `PostgresAuthorizedEventManagementExecutor.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
    isolationStrategy: "Event mutation is capability-gated and remains inside one Tenant-bound PostgreSQL transaction.",
    requiredNegativeTestIds: ["events.authorization"],
    operation: `PostgresAuthorizedEventManagementExecutor.${operation}`,
  })),
  {
    id: "events.management",
    category: "application_service",
    implementationPath: "src/application/events/manage-events.ts",
    surface: "EventManagementService",
    tenantScope: "TENANT_SCOPED",
  ...
  ...(["createEvent", "editEvent", "publishEvent", "postponeEvent", "republishEvent", "cancelEvent"] as const).map((operation) => ({
    ...
    category: "application_service" as const,
    implementationPath: "src/application/events/manage-events.ts",
    surface: `EventManagementService.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
    isolationStrategy: "Event management operation rejects mismatched Tenant scope before the gateway and uses trusted actor facts.",
    requiredNegativeTestIds: ["events.management"],
  ...
  ...(["getEventForRead", "listEvents"] as const).map((operation) => ({
    id: `events.read-${operation}`,
    category: "application_service" as const,
    implementationPath: "src/application/events/read-events.ts",
    surface: `ReadEventService.${operation}`,
    tenantScope: "TENANT_SCOPED" as const,
    isolationStrategy: "Event read operation binds viewer and Tenant before exposing only bounded projections.",
    requiredNegativeTestIds: ["events.direct", "events.collection"],
    operation: `ReadEventService.${operation}`,
  })),
  {
    id: "events.home",
    category: "application_service",
    implementationPath: "src/application/content/campus-home.ts",
    surface: "CampusHomeService Event selection",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Home requests the next eligible upcoming Event through the existing Membership-backed trusted-context seam.",
    requiredNegativeTestIds: ["events.home"],
  },
  {
    id: "events.home-operation",
    category: "application_service",
    implementationPath: "src/application/content/campus-home.ts",
    surface: "CampusHomeService.getFeed Event selection",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Home Event selection is chronological, bounded, and does not broaden the existing Publication Tenant boundary.",
    requiredNegativeTestIds: ["events.home"],
  },
  {
    id: "events.discover",
    category: "application_service",
    implementationPath: "src/application/events/read-events.ts",
    surface: "Discover-consumable Event collection",
    tenantScope: "TENANT_SCOPED",
    isolationStrategy: "Discover consumes only the bounded server-side Event list seam; no new frontend or router is introduced.",
    requiredNegativeTestIds: ["events.discover"],
  },
  {
    id: "event.services.factory",
    category: "infrastructure",
    implementationPath: "src/server/events/create-event-services.ts",
    surface: "createEventServices",
    tenantScope: "GLOBAL_NON_TENANT",
    isolationStrategy: "The factory only wires server-side Event dependencies; all returned resource operations remain Tenant-bound.",
    requiredNegativeTestIds: [],

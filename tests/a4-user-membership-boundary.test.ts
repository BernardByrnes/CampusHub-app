...
describe("A4 User/Membership boundary", () => {
  ...
  it("structurally finds every current Tenant-owned ID-bearing model in the inventory", () => {
    ...
    for (const identifier of [
      ...
      "xpLedgerEntry.adjustmentIntentId",
      "xpSourceClaim.id",
      ...
      "sports.tenant_id -> tenants.id",
      "competitions.tenant_id -> tenants.id",
      "competitions.(tenant_id,sport_id) -> sports.(tenant_id,id)",
      "competitions.(tenant_id,campus_id) -> campuses.(tenant_id,id)",
      "teams.tenant_id -> tenants.id",
      "teams.(tenant_id,sport_id) -> sports.(tenant_id,id)",
      "fixtures.tenant_id -> tenants.id",
      "fixtures.(tenant_id,competition_id) -> competitions.(tenant_id,id)",
      "fixtures.(tenant_id,home_team_id) -> teams.(tenant_id,id)",
      "fixtures.(tenant_id,away_team_id) -> teams.(tenant_id,id)",
      "fixtures.(tenant_id,campus_id) -> campuses.(tenant_id,id)",
      "results.tenant_id -> tenants.id",
      "results.(tenant_id,fixture_id) -> fixtures.(tenant_id,id)",
      "result_revisions.tenant_id -> tenants.id",
      "result_revisions.(tenant_id,result_id) -> results.(tenant_id,id)",
      ...
      "xp_ledger_entries.(tenant_id,membership_id,source_entry_id) -> xp_ledger_entries.(tenant_id,membership_id,id)",
